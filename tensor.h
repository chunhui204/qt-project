...
public:
	...
	Tensor slice_col(int pos, int start_col, int end_col) const;
	Tensor slice_row(int start_row, int end_row, int pos) const;
	...
	void vector_max(double &val, int &pos) const;
private:
    double * buffer;
    int row;
    int col;
